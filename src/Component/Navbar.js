  ...
  <div className="drawer-content flex flex-col">
    ...
    <div className="w-full navbar bg-base-300">
     ...
     <ul className='flex justify-center items-center gap-5'>
      <li className='text-green-900 text-3xl'>BLOG WEB</li>
      <li > <CustomLink className='p-2 mr-3' to={'/'}>Blogs</CustomLink> </li>
      <li><CustomLink className='p-2 mr-3' to={'/my-blog'}>My Blogs</CustomLink></li>
      <li><CustomLink className='p-2 mr-3' to={'/create-blog'}>Create Blogs</CustomLink></li>
     </ul>
      </div>
