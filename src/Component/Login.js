    ...
    const handleSubmit = async (e)=>{
       ...
       try {
           ...
           if(data?.data){
            ...
            localStorage.setItem("user",JSON.stringify(payload2))
...
{loading &&      <div className='flex flex-col items-center'>
   ...
   <p className='text-center py-2'>Not Sign Up please <Link to='/signup' className='text-blue-600' >sign up</Link></p>
